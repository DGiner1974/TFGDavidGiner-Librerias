 ...
 */
public class PanelUsuarioAutonomo1 extends LeafComponent {
    ...
    public void setUsuarioSeleccionado(Usuario nuevoUsuario) {
        System.out.println("PanelUsuarioAutonomo1 usuarioSeleccionado: " +  this.usuarioSeleccionado.toString() + " - " + "nuevoUsuario: " + nuevoUsuario.toString());
