...
/**
 * Componente de hoja que encapsula un {@link javax.swing.JTextField} para la
 ...
 * introducir un valor mediante un campo de texto. Implementa la interfaz
 * {@link es.uned.TFGDavidGiner.core.interfaces.IValidation} para asegurar que 
 * el valor introducido sea un númeroválido dentro del rango de 0 a 100.
 *
 * @author david
 * @version 1.0
 * @since 12-07-2025
 */
public class ComponenteD extends LeafComponent {
    ...
    * <p>
    * Se activa cuando el usuario presiona 'Enter'. Actualiza la propiedad 'data'
    * del componente con el texto introducido.
    *
    * @param evt El evento de acción.
    */
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        setData(jTextField1.getText());
     ...
     * <p>
     * Actualiza el estado interno, sincroniza la vista (JTextField) y notifica
